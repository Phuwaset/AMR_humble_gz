...
def generate_launch_description():
    ...
    robot_namespace = LaunchConfiguration("robot_namespace", default='amr_mtt')
    
    # Path to the Xacro file
    xacro_path = join(amr_mtt_path, 'urdf', 'amr_mtt.xacro')
    ...
    spawn_entity = Node(
        ...
        arguments=[
            ...
            '-entity', PythonExpression(['"', robot_namespace, '_robot"']), #default enitity name _amr_mtt
            '-z', "0.28",
            '-x', position_x,
            '-y', position_y,
            '-Y', orientation_yaw
